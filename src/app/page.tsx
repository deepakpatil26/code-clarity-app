  ...
  return (
    <div className="flex flex-col min-h-screen selection:bg-primary/30">
          ...
          >
            <div className="relative rounded-2xl border bg-card p-1 shadow-2xl overflow-hidden group">
              ...
              <Image
                ...
                width={1200}
                height={800}
                className="rounded-xl shadow-inner border border-primary/20"
                unoptimized
              />
            </div>
            {/* Decorative Elements */}
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto rounded-3xl bg-gradient-to-br from-primary to-accent p-6 sm:p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden group">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-6 relative z-10">Ready to Upgrade Your Code Quality?</h2>
            <p className="text-base sm:text-xl mb-10 text-white/80 relative z-10 max-w-2xl mx-auto">
